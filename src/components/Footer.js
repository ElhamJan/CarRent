...
const Footer = () => {
  ...
  return (
    <footer
      className={`px-6 md:pt-7 md:bg-white ${
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div>
          <ul className="flex justify-between items-center gap-x-10 gap-y-7 flex-wrap">
            <li className="pr-5">
              <p className="font-bold mb-2">About</p>
              <ul className="text-secondary text-sm flex flex-col gap-y-2">
                <li>
                  <p>How it works</p>
                </li>
                <li>
      ...
      <hr className="hidden md:block text-secondary my-7" />
      <div className="grid grid-cols-1 md:flex md:flex-row-reverse md:justify-between md:items-center gap-y-4 text-xs font-semibold mt-8 mb-3">
